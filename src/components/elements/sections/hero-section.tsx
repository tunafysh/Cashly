...
export default function HeroSection() {
  ...
  return (
    <div
      className="min-h-screen bg-linear-to-b from-primary/15 rounded-lg via-primary-15 to-background flex flex-col items-center justify-center px-4 md:px-8 py-12 pt-5 md:py-20"
      id="home"
    >
      ...
      <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground text-center mb-8 md:mb-12 max-w-2xl px-2">
        Manage your finances with ease and precision. Track expenses, set
        budgets, and achieve your financial goals with a beautiful, intuitive
        interface.
      </p>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 md:gap-4 mb-16 md:mb-20 w-full sm:w-auto">
        <a href="/signup" className="w-full sm:w-auto">
          <Button
            size="lg"
            className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-6 md:px-8 w-full"
          >
            Get Started
        ...
        <a href="#features" className="w-full sm:w-auto">
          <Button
            size="lg"
            variant="outline"
            className="font-semibold px-6 md:px-8 w-full"
          >
            Learn More
          </Button>
        </a>
