...
export default function Features() {
    const features = [
        {
            ...
            details: "Completely transparent and open-source. Customize it for your needs."
        },
        {
            icon: Zap,
            title: "Real-time Sync",
            description: "Instant updates across all devices",
            details: "Your data syncs instantly. Check your finances anywhere, anytime."
        },
        {
            icon: Lock,
            title: "Bank-Level Security",
            description: "Your data protected with encryption",
            details: "Military-grade encryption ensures your financial data stays private."
        },
        {
            icon: BarChart3,
            title: "Smart Analytics",
            description: "Deep insights into your spending",
            details: "Visualize trends and patterns to make smarter financial decisions."
        },
        {
            icon: PieChart,
        ...
        },
        {
            ...
            details: "Stay informed with customizable notifications when limits are reached."
        }
    ];
    ...
    return (
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-4 md:mb-6 max-w-3xl bg-linear-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent leading-tight">
            ...
            <p className="text-center text-muted-foreground mb-12 md:mb-16 max-w-2xl mx-auto px-4">Everything you need to manage your finances beautifully</p>
                ...
                {features.map((feature, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Title */}
                            <p className="text-xl md:text-lg font-bold text-foreground mb-3 relative z-10 group-hover:text-primary transition-colors">{feature.title}</p>
                            
                            {/* Main description */}
                            <p className="text-sm md:text-base text-muted-foreground mb-4 font-semibold relative z-10">{feature.description}</p>
                            
                            {/* Detailed description */}
                            <p className="text-xs md:text-sm text-muted-foreground/80 leading-relaxed relative z-10 group-hover:text-muted-foreground transition-colors">{feature.details}</p>
