...
export default function Contact() {
    return (
        <div className="w-full max-w-2xl rounded-xl border border-border/30 bg-linear-to-br from-primary/5 to-background p-8 md:p-12 shadow-lg shadow-primary/5 mx-4 md:mx-auto" id="about">
            <div className="space-y-6">
                ...
                <div className="pt-6 border-t border-border/20">
                    <p className="font-semibold text-foreground text-center text-2xl mb-4">Follow Us</p>
