    ...
    <nav className="w-full border-b border-border/40 backdrop-blur-sm sticky top-0 z-50 bg-background/80">
      <div className="flex items-center justify-between py-4 md:py-6 px-4 md:px-8">
        ...
        >
          ...
          <div className="text-lg md:text-2xl font-bold bg-linear-to-r from-primary to-primary/70 bg-clip-text text-transparent">
            Cashly
          </div>
        </a>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <a href="/login" className="hidden sm:block">
            <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-sm md:text-base">
              Login
            </Button>
          </a>
          <button
