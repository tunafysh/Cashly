...
const GoogleBottomGradient = () => {
  return (
    <div className="absolute w-full bottom-0 left-2">
      ...
      <span className="group-hover/btn:opacity-100 block transition duration-500 opacity-0 absolute left-[-16%] h-px w-[25%] mx-auto -bottom-px inset-x-10 bg-red-500" />
...
const GithubBottomGradient = () => {
  return (
    <div className="">
      <span className="group-hover/btn:opacity-100 block transition duration-500 opacity-0 absolute h-px w-full -bottom-px inset-x-0 bg-linear-to-r from-transparent via-slate-950 dark:via-slate-50 to-transparent" />
      <span className="group-hover/btn:opacity-100 blur-sm block transition duration-500 opacity-0 absolute h-px w-full -bottom-px inset-x-10 bg-linear-to-r from-transparent via-slate-950 dark:via-slate-50 to-transparent left-2" />
    </div>
  );
};
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-balance text-muted-foreground">
                  Enter your information to create a Cashly account
                </p>
              </div>
              <Field>
              ...
              <Field className="grid grid-rows-2 gap-4">
                <Button variant="outline" type="button" className="group/btn relative gap-4 ">
